...
class Chunking:
    ...
    def __init__(self, data_dir: str):
        ...
        self.recursive_splitter = RecursiveCharacterTextSplitter(chunk_size=CHUNK_SIZE, chunk_overlap=OVERLAP_SIZE)
    ...
    def chunk_file(self, file: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if "error" in file:
            logger.warning(f"Skipping chunking for the file - {filepath} due to error - {file['error']}")
            return chunks
        ...
        try:
            ...
            # Further chunking using RecursiveCharacterTextSplitter
            for chunk in header_chunks:
                ...
                for split_chunk in split_chunks:
                    chunks.append({
                        ...
                        "metadata": {
                            "source": filepath,
                            **chunk.metadata  # Include header metadata
                        }
                    })
    ...
    def process_directory(self) -> List[Dict[str, Any]]:
        ...
        with ThreadPoolExecutor(max_workers=2) as executor:
            try:
                ...
                logger.error(f"Error processing the files from the directory - {self.data_dir}: {e}")
